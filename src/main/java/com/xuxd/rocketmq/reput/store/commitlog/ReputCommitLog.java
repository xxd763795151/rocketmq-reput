...
import com.xuxd.rocketmq.reput.store.ReputMappedFileQueue;
...
/**
 * daily-demo. See {@link org.apache.rocketmq.store.CommitLog}
 *
 * @author xuxd
 * @date 2021-06-28 14:57:58
 * @description daily-demo
 **/
@Slf4j
public class ReputCommitLog {
    ...
    protected final ReputMappedFileQueue mappedFileQueue;
    ...
    public ReputCommitLog(ReputMessageStore messageStore) {
        this.messageStore = messageStore;
        this.mappedFileQueue = new ReputMappedFileQueue(messageStore.getMessageStoreConfig().getStorePathCommitLog(),
    ...
    public void recoverNormally(long maxPhyOffsetOfConsumeQueue) {
        ...
        if (!mappedFiles.isEmpty()) {
            // Began to recover from the last file
            ...
            this.messageStore.destroyLogics();
        }
    }
    ...
    public DispatchRequest checkMessageAndReturnSize(ByteBuffer byteBuffer, final boolean checkCRC,
        ...
        try {
            ...
            if (propertiesLength > 0) {
                ...
                // Timing message do not processing
                {
...
//                doNothingForDeadCode(byteBuffer2);
    ...
    public SelectMappedBufferResult getData(final long offset, final boolean returnFirstOnNotFound) {
        ...
        if (mappedFile != null) {
            ...
            if (result == null) {
                // 没有读取到数据，就认为到文件尾部了，还有下个文件，直接读取下一个文件吧
                if (mappedFile.getReadPosition() <= offset && offset < getMaxOffset()) {
                    ...
                    if (nextFile != null && nextFile.hold()) {
                        ...
                        byteBuffer.limit(nextFile.getReadPosition());
                        return new SelectMappedBufferResult(nextFile.getFileFromOffset(), byteBuffer, size, nextFile);
                    }
                }
            }
            return result;
